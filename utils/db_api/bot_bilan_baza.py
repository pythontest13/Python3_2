...
"""
  ...
  #************************************************************************************
    ...
    def user_qoshish(self, ism: str,tg_id: int, familya: str = None, username: str = None ):
        #SQL_EXAMPLE = "INSERT INTO myfiles_teacher(id, Name, email) VALUES(1, 'John', 'John@gmail.com')"

        sql = """
        INSERT INTO users(ism, familya, username, tg_id) VALUES(?, ?, ?, ?)
        """
        self.execute(sql, parameters=(ism, familya, username, tg_id), commit=True)
